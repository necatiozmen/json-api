...
* [refine-jsonapi](https://github.com/mahirmahdi/refine-jsonapi) - A data provider package for [Refine](https://refine.dev/) that provides an implementation for working with JSON:API specifications that conform to a standard API design.
